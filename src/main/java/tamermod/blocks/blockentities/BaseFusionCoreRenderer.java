...
public class BaseFusionCoreRenderer implements BlockEntityRenderer<BaseInjectorBlockEntity> {
    public BaseFusionCoreRenderer(BlockEntityRendererProvider.Context context) {
    }
